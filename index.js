...
// ANSWER: Yeah sure, here you go:

const getNumSqrs = nums => {
  let answers = []
  nums.forEach(num => {
    let sqrd = num * num
    answers.push(sqrd)
...
// ANSWER: The first function is delcaring 2 variables and 5 operations, while the second function
// is declaring 1 variable, and 5 operations. Therefore the second function has a more effecient 
// space complexity
